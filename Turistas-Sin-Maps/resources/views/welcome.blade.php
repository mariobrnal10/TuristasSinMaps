...
<section id="hero" class="hero" style="background-image: url('{{ asset('img/avion2.webp') }}'); background-size: cover; background-position: center; background-repeat: no-repeat; width: 100vw; height: 75vh; position: relative; transition: background-image 1s ease-in-out;">
